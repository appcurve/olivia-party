import type { Video, VideoPlaylist } from '@prisma/client'
...
export type VideoGroupModelResponseDto = Pick<VideoPlaylist, typeof VIDEO_GROUP_MODEL_PUBLIC_FIELDS[number]>
